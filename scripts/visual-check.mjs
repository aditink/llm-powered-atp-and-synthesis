...
await page.goto("http://127.0.0.1:5173/llm-powered-atp-and-synthesis/", { waitUntil: "networkidle" });
...
await page.goto("http://127.0.0.1:5173/llm-powered-atp-and-synthesis/#prompts", { waitUntil: "networkidle" });
...
for (const route of ["cases", "results", "prompts"]) {
  ...
  await page.goto(`http://127.0.0.1:5173/llm-powered-atp-and-synthesis/#${route}`, { waitUntil: "networkidle" });
...
await page.goto("http://127.0.0.1:5173/llm-powered-atp-and-synthesis/#overview", { waitUntil: "networkidle" });
